/* Floodfill algo by czartacus, their sketch:
https://editor.p5js.org/czartacus/sketches/kgMaXJBYd
with some minor changes by Steve
*/
...
function floodFill(seed, fillColor) {
  //seed is vector (x,y) where paintbucket is pointed to
  loadPixels();
